...
- Peer capability exchange, a quorum-committed feature-level image, metadata-format negotiation through format 9, and a committed compatibility floor that survives controller loss while prospective voters still require a live compatibility check.
