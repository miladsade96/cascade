...
The release gate also runs the full Kafka 4.3.1 end-to-end suite and the three-broker coordinator fault tests. A passing unit suite alone is not delivery qualification.
