...
The current release is `1.2.0`. I use the root `VERSION` file as the release source of truth and keep the broker capability, build, container, and deployment metadata aligned with it. The 1.2.0 Docker image is a local build; I have not published that tag to Docker Hub yet.
